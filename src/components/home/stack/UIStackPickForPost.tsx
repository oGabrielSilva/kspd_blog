...
interface IProps {
  openUP?: boolean
  id: string
  selectedStacks: TStackForPost[]
  setSelectedStacks(newState: TStackForPost[]): void
}

export function UIStackPickForPost(props: IProps) {
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    props.setSelectedStacks(
                      find
                        ? props.selectedStacks.filter(({ uid }) => uid !== stack.uid)
                        : [...props.selectedStacks, stack],
                    )
                  }}
                >
                  <span>
