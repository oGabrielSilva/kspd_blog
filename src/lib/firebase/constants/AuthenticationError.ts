export class AuthenticationError {
  public static readonly messages: { [key: string]: string } = {
    ...
    'auth/captcha-check-failed': 'Falha na verificação do captcha',
    ...
    'auth/custom-token-mismatch': 'Token personalizado não corresponde',
    ...
    'auth/email-change-needs-verification': 'Mudança de e-mail precisa de verificação',
    ...
    'auth/invalid-app-id': 'ID do aplicativo inválido',
    ...
    'auth/invalid-emulator-scheme': 'Esquema do emulador inválido',
    ...
    'auth/multi-factor-info-not-found': 'Informação de múltiplos fatores não encontrada',
    'auth/multi-factor-auth-required': 'Autenticação de múltiplos fatores necessária',
    'auth/missing-android-pkg-name': 'Nome do pacote Android ausente',
    'auth/missing-app-credential': 'Credencial do aplicativo ausente',
    'auth/auth-domain-config-required': 'Configuração do domínio de autenticação necessária',
    ...
    'auth/missing-multi-factor-info': 'Informação de múltiplos fatores ausente',
    ...
    'auth/app-deleted': 'Aplicativo deletado',
    'auth/account-exists-with-different-credential': 'Conta existe com uma credencial diferente',
    'auth/network-request-failed': 'Falha na requisição de rede',
    ...
    'auth/second-factor-already-in-use': 'Segundo fator já está em uso',
    'auth/maximum-second-factor-count-exceeded': 'Número máximo de fatores secundários excedido',
    'auth/tenant-id-mismatch': 'ID do locatário não corresponde',
    'auth/timeout': 'Tempo de espera esgotado',
    ...
    'auth/user-cancelled': 'Usuário cancelou a operação',
    'auth/user-not-found': 'Usuário não encontrado',
    'auth/user-disabled': 'Usuário desativado',
    'auth/user-mismatch': 'Usuário não corresponde',
    ...
    'auth/missing-recaptcha-token': 'Token do reCAPTCHA ausente',
    'auth/invalid-recaptcha-token': 'Token do reCAPTCHA inválido',
    'auth/invalid-recaptcha-action': 'Ação do reCAPTCHA inválida',
    'auth/missing-client-type': 'Tipo de cliente ausente',
    'auth/missing-recaptcha-version': 'Versão do reCAPTCHA ausente',
    'auth/invalid-recaptcha-version': 'Versão do reCAPTCHA inválida',
    'auth/invalid-req-type': 'Tipo de requisição inválido',
  }

  public static readonly codes: { [key: string]: string } = {
